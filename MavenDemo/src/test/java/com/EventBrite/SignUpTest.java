...
public class SignUpTest extends JFrame {
    ...
    static HashMap<String, UserDatabaseTest> knownUsers = new HashMap<String, UserDatabaseTest>();
     ...
     * Create the frame.
     */
    public SignUpTest(HashMap<String, UserDatabaseTest> theUsers, LoginPageTest loginPage) {
        knownUsers = theUsers;
    ...
    public boolean IExist(String inputName) {
        ...
        for (int i = 0; i < knownUsers.size(); i++) {
            ...
            if (knownUsers.get(i).getUsername().equals(inputName)) {
                ...
                try {
                    ...
                    x++;
                    UserDatabaseTest user = new UserDatabaseTest(txtUsername.getText(), txtPassword.getText(), txtEmail.getText(), UserType.MEMBER);
